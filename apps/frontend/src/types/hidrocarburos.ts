...
export type HydrocarburosInvoiceRow = {
  ...
  werks: string | null; sitio_consumo: string | null; confianza_mseg: "Alta" | "Media" | null;
  claves_gas?: string[] | null;
  material: string | null; cantidad: number | null; clave_unidad: string | null;
};
